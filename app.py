...
def render_status(host):
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="color-scheme" content="light dark"><link rel="icon" type="image/png" sizes="64x64" href="{FAVICON_DATA_URI}"><link rel="icon" type="image/png" sizes="64x64" href="/favicon.png?v=0910"><link rel="shortcut icon" href="/favicon.ico?v=0910"><link rel="apple-touch-icon" href="/favicon.png?v=0910"><meta name="theme-color" content="#b3261e"><title>Block page</title><style>{CSS}</style></head><body><main class="status"><header><h1 class="title">Block page</h1><p class="lead">The service is running and ready for AdGuard Home.</p><div class="domain">{esc(host)}</div></header></main></body></html>'''.encode()
...
def render_blocked(host, device, details):
    ...
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover"><meta name="color-scheme" content="light dark"><link rel="icon" type="image/png" sizes="64x64" href="{FAVICON_DATA_URI}"><link rel="icon" type="image/png" sizes="64x64" href="/favicon.png?v=0910"><link rel="shortcut icon" href="/favicon.ico?v=0910"><link rel="apple-touch-icon" href="/favicon.png?v=0910"><meta name="theme-color" content="#b3261e"><title>Blocked — {esc(host)}</title><style>{CSS}</style></head><body><main><header><p class="eyebrow">DNS filtering</p><h1 class="title">Blocked</h1><p class="lead">Your network prevented this destination from loading.</p><div class="domain">{esc(host)}</div></header>{device_html}{blocked_html}{dns_html}{technical_html}{note}</main></body></html>'''.encode()
