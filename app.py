...
*{box-sizing:border-box}html{-webkit-text-size-adjust:100%}body{margin:0;background:var(--bg);color:var(--text);font:13.25px/1.38 -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif}
main{width:min(640px,100%);margin:0 auto;padding:max(24px,env(safe-area-inset-top)) max(15px,env(safe-area-inset-right)) max(26px,env(safe-area-inset-bottom)) max(15px,env(safe-area-inset-left))}
header{padding-bottom:14px;border-bottom:1px solid var(--line)}.eyebrow{margin:0 0 3px;color:var(--muted);font-size:11.5px;font-weight:650}.title{margin:0;font-size:24px;line-height:1.08;letter-spacing:-.018em;font-weight:680}.lead{margin:4px 0 0;color:var(--muted)}.domain{margin-top:10px;padding:7px 9px;background:var(--soft);border:1px solid var(--line);border-radius:6px;font:600 13.5px/1.35 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;overflow-wrap:anywhere}
section{margin-top:15px}.section-title{margin:0 0 5px;font-size:12.75px;font-weight:680}.panel{border:1px solid var(--line);border-radius:7px;overflow:hidden}.row{display:grid;grid-template-columns:86px minmax(0,1fr);gap:10px;padding:6px 9px;border-bottom:1px solid var(--line)}.row:last-child{border-bottom:0}.label{color:var(--muted)}.value{min-width:0;overflow-wrap:anywhere}.name{font-weight:650}.mono{font:11.25px/1.35 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;overflow-wrap:anywhere}
.rule{padding:8px 0;border-top:1px solid var(--line)}.rule:first-child{border-top:0}.rulehead{display:flex;justify-content:space-between;gap:6px 10px;align-items:center}.filter{font-weight:650;line-height:1.25}.meta{display:flex;gap:4px;flex-wrap:wrap;justify-content:flex-end}.pill{padding:0 5px;border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:9.75px;line-height:1.6;white-space:nowrap}.ruletext{margin-top:4px;padding:6px 8px;background:var(--code);border-radius:5px;font:11.2px/1.35 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;overflow-wrap:anywhere}
.fallback{padding:7px 9px;border:1px solid var(--line);border-radius:7px}details{margin-top:15px;border-top:1px solid var(--line);padding-top:7px}summary{color:var(--muted);cursor:pointer;font-size:11.5px}.technical{margin-top:5px;color:var(--muted);font-size:10.75px;line-height:1.3;display:grid;gap:1px}.technical div{margin:0;overflow-wrap:anywhere}.technical .mono{font-size:10.25px}.note{margin-top:11px;color:var(--muted);font-size:10.75px}.status{min-height:64vh;display:grid;align-content:center}.status header{border-bottom:0}
@media(max-width:520px){main{padding-left:12px;padding-right:12px;padding-top:max(18px,env(safe-area-inset-top))}.title{font-size:22.5px}.row{grid-template-columns:76px minmax(0,1fr);gap:8px;padding:5.5px 8px}.domain{font-size:12.5px}.mono,.ruletext{font-size:10.6px}.section-title{font-size:12.25px}}
@media(max-width:340px){.row{grid-template-columns:1fr;gap:1px}.rulehead{display:block}.meta{justify-content:flex-start;margin-top:3px}}
'''
