...
*{box-sizing:border-box}html{-webkit-text-size-adjust:100%}body{margin:0;background:var(--bg);color:var(--text);font:15px/1.42 -apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif}
main{width:min(700px,100%);margin:0 auto;padding:max(34px,env(safe-area-inset-top)) max(20px,env(safe-area-inset-right)) max(36px,env(safe-area-inset-bottom)) max(20px,env(safe-area-inset-left))}
header{padding-bottom:20px;border-bottom:1px solid var(--line)}.eyebrow{margin:0 0 4px;color:var(--muted);font-size:12.5px;font-weight:650}.title{margin:0;font-size:30px;line-height:1.08;letter-spacing:-.02em;font-weight:680}.lead{margin:6px 0 0;color:var(--muted)}.domain{margin-top:14px;padding:10px 12px;background:var(--soft);border:1px solid var(--line);border-radius:8px;font:600 15.5px/1.4 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;overflow-wrap:anywhere}
section{margin-top:22px}.section-title{margin:0 0 7px;font-size:14.5px;font-weight:680}.panel{border:1px solid var(--line);border-radius:9px;overflow:hidden}.row{display:grid;grid-template-columns:100px minmax(0,1fr);gap:14px;padding:9px 12px;border-bottom:1px solid var(--line)}.row:last-child{border-bottom:0}.label{color:var(--muted)}.value{min-width:0;overflow-wrap:anywhere}.name{font-weight:650}.mono{font:12.5px/1.4 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;overflow-wrap:anywhere}
.rule{padding:11px 0;border-top:1px solid var(--line)}.rule:first-child{border-top:0}.rulehead{display:flex;justify-content:space-between;gap:8px 12px;align-items:center}.filter{font-weight:650;line-height:1.25}.meta{display:flex;gap:5px;flex-wrap:wrap;justify-content:flex-end}.pill{padding:1px 6px;border:1px solid var(--line);border-radius:999px;color:var(--muted);font-size:10.5px;line-height:1.6;white-space:nowrap}.ruletext{margin-top:6px;padding:8px 10px;background:var(--code);border-radius:6px;font:12.5px/1.4 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;overflow-wrap:anywhere}
.fallback{padding:9px 11px;border:1px solid var(--line);border-radius:8px}details{margin-top:20px;border-top:1px solid var(--line);padding-top:9px}summary{color:var(--muted);cursor:pointer;font-size:12.5px}.technical{margin-top:6px;color:var(--muted);font-size:11.5px;line-height:1.32;display:grid;gap:2px}.technical div{margin:0;overflow-wrap:anywhere}.technical .mono{font-size:11px}.note{margin-top:13px;color:var(--muted);font-size:11.5px}.status{min-height:68vh;display:grid;align-content:center}.status header{border-bottom:0}
@media(max-width:520px){main{padding-left:14px;padding-right:14px;padding-top:max(24px,env(safe-area-inset-top))}.title{font-size:27.5px}.row{grid-template-columns:86px minmax(0,1fr);gap:10px;padding:8px 10px}.domain{font-size:14.5px}.mono,.ruletext{font-size:11.7px}.section-title{font-size:14px}}
